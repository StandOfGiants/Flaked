...
const ChooseTitleDialog = preload("res://addons/dialog_manager/views/choose_title_dialog.gd")
...
func _ready() -> void:
	...
	menu.add_icon_item(
		...
		103,
		KEY_MASK_CTRL | KEY_MASK_SHIFT | KEY_SPACE
	)
	...
	goto_color.a = 0.7
	var dialog_color = get_color("mono_color", "Editor")
	...
	# Dialog
	add_color_region(": ", "::", dialog_color, true)
