...
var npc_portraits = {
	...
	# Bar patrons
	"Brook": load("res://entities/npc/Bartender/Bartender_portrait.png"),
	"Bartender": load("res://entities/npc/Bartender/Bartender_portrait.png"),
	"Benny": load("res://entities/npc/Benny/Benny_portrait.png"),
	"Benny SAD": load("res://entities/npc/Benny/Benny_portrait_sad.png"),
	"Benny HAPPY": load("res://entities/npc/Benny/Benny_portrait_happy.png"),
	"Don": load("res://entities/npc/Don/Don_portrait.png"),
	"Don SAD": load("res://entities/npc/Don/Don_portrait_sad.png"),
	"Don HAPPY": load("res://entities/npc/Don/Don_portrait_happy.png"),
	"Kat": load("res://entities/npc/Kat/Kat_portrait.png"),
	"Kat SAD": load("res://entities/npc/Kat/Kat_portrait_sad.png"),
	"Kat HAPPY": load("res://entities/npc/Kat/Kat_portrait_happy.png"),
	"Sarah": load("res://entities/npc/Sarah/Sarah_portrait.png"),
	"Sarah SAD": load("res://entities/npc/Sarah/Sarah_portrait_sad.png"),
	"Sarah HAPPY": load("res://entities/npc/Sarah/Sarah_portrait_happy.png"),
	"Tony Macaroni": load("res://entities/npc/TonyMacaroni/TonyMacaroni_portrait.png"),
	"Tony Macaroni SAD": load("res://entities/npc/TonyMacaroni/TonyMacaroni_portrait_sad.png"),
	"Tony Macaroni HAPPY": load("res://entities/npc/TonyMacaroni/TonyMacaroni_portrait_happy.png"),
	"Troy": load("res://entities/npc/Troy/Troy_portrait.png"),
	"Troy SAD": load("res://entities/npc/Troy/Troy_portrait_sad.png"),
	"Troy HAPPY": load("res://entities/npc/Troy/Troy_portrait_happy.png"),
	# Player
